...
angular.module("brianleeApp").run(["$templateCache", function($templateCache) {$templateCache.put("app/about/about.html","<header class=\"hero-unit\" id=\"banner\">\n  </div>\n</header><div>This is the interests view.</div>\n");
